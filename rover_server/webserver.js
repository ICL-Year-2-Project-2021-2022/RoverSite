...
server.get('/assets/forward.png', function(req,res){
    res.sendFile('/home/ubuntu/RoverSite/rover_server/assets/forward.png');
});
server.get('/assets/backward.png', function(req,res){
    res.sendFile('/home/ubuntu/RoverSite/rover_server/assets/backward.png');
}); 
server.get('/assets/clockwise.png', function(req,res){
    res.sendFile('/home/ubuntu/RoverSite/rover_server/assets/clockwise.png');
});
server.get('/assets/anticlockwise.png', function(req,res){
    res.sendFile('/home/ubuntu/RoverSite/rover_server/assets/anticlockwise.png');
});
